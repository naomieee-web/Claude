...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/10 px-6 md:px-12 lg:px-16">
      ...
      <div className="relative w-full overflow-hidden py-12 bg-black h-64">
        ...
        {tags.map(({ label, color, pos, duration, delay }) => (
          <span
            key={label}
            className={`float-tag absolute rounded-full px-5 py-2 text-sm font-medium text-black ${color} ${pos}`}
